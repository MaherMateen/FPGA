...
#set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets lr_IBUF]
#set_property LOC BUFG_multi [get_cells lr_IBUF_BUFG_inst]
# Assuming sq_wave is an output signal with I/O standard LVCMOS33
#set_property -dict { PACKAGE_PIN <pin_name>; IOSTANDARD LVCMOS33 } [get_ports {sq_wave}]
...
set_property -dict {PACKAGE_PIN R17 IOSTANDARD LVCMOS33} [get_ports {m[0]}]
set_property -dict {PACKAGE_PIN T18 IOSTANDARD LVCMOS33} [get_ports {m[1]}]
set_property -dict {PACKAGE_PIN U18 IOSTANDARD LVCMOS33} [get_ports {m[2]}]
set_property -dict {PACKAGE_PIN R13 IOSTANDARD LVCMOS33} [get_ports {m[3]}]
#set_property -dict { PACKAGE_PIN T8    IOSTANDARD LVCMOS18 } [get_ports { in[8] }]; #IO_L24N_T3_34 Sch=sw[8]
set_property -dict {PACKAGE_PIN U8 IOSTANDARD LVCMOS18} [get_ports rst]
#set_property -dict { PACKAGE_PIN R16   IOSTANDARD LVCMOS33 } [get_ports { SW[10] }]; #IO_L15P_T2_DQS_RDWR_B_14 Sch=sw[10]
#set_property -dict { PACKAGE_PIN T13   IOSTANDARD LVCMOS33 } [get_ports { amt[0] }]; #IO_L23P_T3_A03_D19_14 Sch=sw[11]
#set_property -dict { PACKAGE_PIN H6    IOSTANDARD LVCMOS33 } [get_ports { amt[1] }]; #IO_L24P_T3_35 Sch=sw[12]
#set_property -dict { PACKAGE_PIN U12   IOSTANDARD LVCMOS33 } [get_ports { amt[2] }]; #IO_L20P_T3_A08_D24_14 Sch=sw[13]
#set_property -dict { PACKAGE_PIN U11   IOSTANDARD LVCMOS33 } [get_ports { amt[3] }]; #IO_L19N_T3_A09_D25_VREF_14 Sch=sw[14]
#set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports { lr }]; #IO_L21P_T3_DQS_14 Sch=sw[15]
...
##Pmod Headers
##Pmod Header JA
set_property -dict {PACKAGE_PIN C17 IOSTANDARD LVCMOS33} [get_ports sq_wave]
